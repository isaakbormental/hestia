 ...
 */
package maps.main.java.com.lynden.gmapsfx.javascript.object;
...
public class MapTypeIdEnum extends JavascriptEnum {
    ...
    private static final String MAP_ENUM = "google.maps.MapTypeId";
    ...
    private static final MapTypeIdEnum SATELLITE = new MapTypeIdEnum("SATELLITE");
    ...
    private MapTypeIdEnum(String value) {
