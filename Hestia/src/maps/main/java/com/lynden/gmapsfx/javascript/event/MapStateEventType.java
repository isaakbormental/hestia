...
package maps.main.java.com.lynden.gmapsfx.javascript.event;
...
public enum MapStateEventType {
    bounds_changed, center_changed, drag, dragend, dragstart,
    heading_changed, idle, maptypeid_changed, projection_changed,
    resize, tilesloaded, tilt_changed, zoom_changed;
}
